...
this["Squarecat"]["templates"]["src/templates/pricingProducts.hbs"] = Handlebars.template({"1":function(depth0,helpers,partials,data) {
...
this["Squarecat"]["templates"]["src/templates/pricingTotal.hbs"] = Handlebars.template({"1":function(depth0,helpers,partials,data) {
    var helper, alias1=helpers.helperMissing, alias2="function", alias3=this.escapeExpression;

  return "  <div class=\"row\"></span>\n    <span class=\"cell\"><i class=\"cart-delete fa fa-times-circle fa-2x\"data-total-name="
  ...
  return "<div class=\"pricing-total-header\">\n  <p class=\"header-total-text\">£"
    ...
    + "</p>\n  <p class=\"header-total-text\">Total</p>\n</div>\n\n<div class=\"pricing-total-items\">\n"
    + ((stack1 = helpers.each.call(depth0,depth0,{"name":"each","hash":{},"fn":this.program(1, data, 0),"inverse":this.noop,"data":data})) != null ? stack1 : "")
    + "</div>\n\n<div class=\"pricing-total-button\">\n  <div class=\"btn btn-green\">\n    <a href=\"#\">Checkout</a>\n  </div>\n</div>";
},"useData":true});